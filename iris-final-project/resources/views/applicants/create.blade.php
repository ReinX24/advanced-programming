                    ...
                    <form method="POST" action="{{ route('applicants.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="working_experience" id="working_experience" rows="6"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('working_experience') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="educational_attainment" id="educational_attainment"
                                ...
                                @foreach (['Primary', 'Secondary', 'Vocational', 'Bachelor', 'Master', 'Doctoral'] as $level)
                                    <option value="{{ $level }}"
                                        {{ old('educational_attainment') == $level ? 'selected' : '' }}>
                                        {{ $level }}
                                    </option>
                                @endforeach
                            </select>
