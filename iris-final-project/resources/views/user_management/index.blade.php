                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($users as $user)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            {{-- If 'role' is a direct column on the users table --}}
                                            @if (isset($user->role))
                                                <span
                                            ...
                                            @else
                                                {{-- If 'roles' is a many-to-many relationship --}}
                                                @forelse ($user->roles as $role)
                                                    <span
                                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-indigo-100 text-indigo-800 mr-1">
                                                        {{ ucfirst($role->name) }}
                                                    </span>
                                                @empty
                                                    <span
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            {{-- Conditionally show "Owner" badge or "Edit" link --}}
